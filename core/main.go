...
import (
	...
	"sigs.k8s.io/external-dns-core/controller"
	"sigs.k8s.io/external-dns-core/pkg/apis/externaldns"
	"sigs.k8s.io/external-dns-core/pkg/apis/externaldns/validation"
	"sigs.k8s.io/external-dns-core/provider/akamai"
	"sigs.k8s.io/external-dns-core/provider/alibabacloud"
	"sigs.k8s.io/external-dns-core/provider/aws"
	"sigs.k8s.io/external-dns-core/provider/awssd"
	"sigs.k8s.io/external-dns-core/provider/azure"
	"sigs.k8s.io/external-dns-core/provider/bluecat"
	"sigs.k8s.io/external-dns-core/provider/civo"
	"sigs.k8s.io/external-dns-core/provider/cloudflare"
	"sigs.k8s.io/external-dns-core/provider/coredns"
	"sigs.k8s.io/external-dns-core/provider/designate"
	"sigs.k8s.io/external-dns-core/provider/digitalocean"
	"sigs.k8s.io/external-dns-core/provider/dnsimple"
	"sigs.k8s.io/external-dns-core/provider/dyn"
	"sigs.k8s.io/external-dns-core/provider/exoscale"
	"sigs.k8s.io/external-dns-core/provider/gandi"
	"sigs.k8s.io/external-dns-core/provider/godaddy"
	"sigs.k8s.io/external-dns-core/provider/google"
	"sigs.k8s.io/external-dns-core/provider/ibmcloud"
	"sigs.k8s.io/external-dns-core/provider/infoblox"
	"sigs.k8s.io/external-dns-core/provider/inmemory"
	"sigs.k8s.io/external-dns-core/provider/linode"
	"sigs.k8s.io/external-dns-core/provider/ns1"
	"sigs.k8s.io/external-dns-core/provider/oci"
	"sigs.k8s.io/external-dns-core/provider/ovh"
	"sigs.k8s.io/external-dns-core/provider/pdns"
	"sigs.k8s.io/external-dns-core/provider/pihole"
	"sigs.k8s.io/external-dns-core/provider/plural"
	"sigs.k8s.io/external-dns-core/provider/rcode0"
	"sigs.k8s.io/external-dns-core/provider/rdns"
	"sigs.k8s.io/external-dns-core/provider/rfc2136"
	"sigs.k8s.io/external-dns-core/provider/safedns"
	"sigs.k8s.io/external-dns-core/provider/scaleway"
	"sigs.k8s.io/external-dns-core/provider/tencentcloud"
	"sigs.k8s.io/external-dns-core/provider/transip"
	"sigs.k8s.io/external-dns-core/provider/ultradns"
	"sigs.k8s.io/external-dns-core/provider/vinyldns"
	"sigs.k8s.io/external-dns-core/provider/vultr"
	"sigs.k8s.io/external-dns-core/provider/webhook"
	"sigs.k8s.io/external-dns-core/registry"
	"sigs.k8s.io/external-dns-core/source"
	"sigs.k8s.io/external-dns-lib/endpoint"
	"sigs.k8s.io/external-dns-lib/plan"
	"sigs.k8s.io/external-dns-lib/provider"
)
